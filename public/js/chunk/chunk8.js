...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(233)("2da0a570", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__add__ = __webpack_require__(624);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__add___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__add__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__edit__ = __webpack_require__(629);
    ...
    methods: {
        ...
        handleTools: function handleTools(type, index, row) {
            ...
            if (type == 'edit') {
                ...
                //删除数据
                Object(__WEBPACK_IMPORTED_MODULE_2__api_article__["l" /* template_del */])(row.id).then(function (response) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(233)("750c530c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_article__ = __webpack_require__(265);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onSubmit: function onSubmit() {
            if (this.handleValid()) {
                this.handleSubmit(Object(__WEBPACK_IMPORTED_MODULE_1__api_article__["k" /* template_add */])(this.form));
            }
        }
    }
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(233)("15d2a0c0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__api_article__["n" /* template_get */])(this.id).then(function (response) {
    ...
    methods: {
        onSubmit: function onSubmit() {
            if (this.handleValid()) {
                this.handleSubmit(Object(__WEBPACK_IMPORTED_MODULE_1__api_article__["m" /* template_edit */])(this.id, this.form));
            }
        }
    }
});
