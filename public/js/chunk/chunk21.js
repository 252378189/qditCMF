...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return config_get; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return configUpdateOrCreate; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return clean; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return sitemap; });
...
var update = __webpack_require__(236)("487b2b93", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_system__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_loading__ = __webpack_require__(285);
    ...
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])(['handleLogOut', 'handleGetMenu', 'GetBaseDataByKey', 'GetBaseDataById']), {
        handleCommand: function handleCommand(command) {
            ...
            if (command == 'logout') {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_1__api_system__["b" /* clean */])().then(function (response) {
                    _this2.$message.success(response.data.msg);
                });
            } else if (command == 'sitemap') {
                Object(__WEBPACK_IMPORTED_MODULE_1__api_system__["h" /* sitemap */])().then(function (response) {
                    _this2.$message.success(response.data.msg);
                });
            }
        }
