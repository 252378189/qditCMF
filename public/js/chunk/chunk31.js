...
/* scopeId */
var __vue_scopeId__ = "data-v-0b5024d8"
...
Component.options.__file = "resources/js/view/form/copyright.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b5024d8", Component.options)
  } else {
    hotAPI.reload("data-v-0b5024d8", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(236)("ad7468aa", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b5024d8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./copyright.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b5024d8\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./copyright.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_system__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_public_table__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_public_table___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_public_table__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_list_page__ = __webpack_require__(260);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "copyright",
    components: { Table: __WEBPACK_IMPORTED_MODULE_1__components_public_table___default.a },
    ...
    methods: {
        handleTools: function handleTools(type, index, row) {
            ...
            if (type == 'delete') {
                Object(__WEBPACK_IMPORTED_MODULE_0__api_system__["a" /* CopyRightDelete */])(row.id).then(function (response) {
                    _this.handleDeleteRow(index);
                    //提示信息
        ...
        handleGetBtn: function handleGetBtn() {
            ...
            var result = {};
            this.$store.state.user.auth.copy_right.forEach(function (item) {
                if (item in conf) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0b5024d8", module.exports)
  }
}
