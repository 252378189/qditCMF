...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__add__ = __webpack_require__(481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__add___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__add__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit__ = __webpack_require__(486);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(236)("669a2702", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onSubmit: function onSubmit() {
            if (this.handleValid()) {
                this.handleSubmit(Object(__WEBPACK_IMPORTED_MODULE_1__api_system__["d" /* menu_add */])(this.form));
            }
        }
    }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(236)("36c8ac84", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.handleGetData(Object(__WEBPACK_IMPORTED_MODULE_0__api_system__["e" /* menu_detail */])(this.id)).then(function (data) {
