...
<script>
    ...
    import {article_get, article_edit, category_List, template_getList} from '@/api/article';
    ...
    export default {
        ...
        created() {
            ...
            //文章数据
            article_get(this.$route.query.id).then(response => {
        ...
        methods: {
            onSubmit(articleForm) {
                ...
                if (this.handleValid(articleForm)) {
                    article_edit(this.$route.query.id, this.articleForm)
                        .then(response => {
